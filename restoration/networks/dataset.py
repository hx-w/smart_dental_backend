...
class PointCloud_with_FreePoints(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # off_surface_coords = np.random.uniform(-11, 11, size=(off_surface_samples//2, 3))
...
class PointCloud_wo_FreePoints(Dataset):
    def __init__(self, pointcloud_path, on_surface_points, instance_idx=None, expand=-1, max_points=-1, *args, **kwargs):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        # off_surface_coords = np.random.uniform(-11, 11, size=(off_surface_samples, 3))
